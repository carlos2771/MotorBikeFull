  ...
  return (
    <div>
      <div className="flex h-[calc(100vh-100px)] items-center justify-center ">
        <animated.div style={formAnimation} className="bg-gradient-to-tr from-[#0f172a] via-[#082f49] to-[#0f172a] max-w-md w-full p-10 rounded-md">
          ...
          <p className="flex gap-x-2 justify-center">
            ¿No tienes cuenta?{' '}
            <Link to="/register" className="text-sky-500 hover:text-yellow-200">
              Registrate
            </Link>
          </p>
        </animated.div>
