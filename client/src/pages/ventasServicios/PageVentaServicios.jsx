        ...
        return (
          <div>
            <button
              ...
              className={`px-4 py-1 m-1 text-sm text-white font-semibold rounded-full border border-green-500 hover:text-white hover:bg-green-500 ${
                estado !== "Finalizada" && estado !== "Inactivo" ? "" : "hidden"
              }`}
