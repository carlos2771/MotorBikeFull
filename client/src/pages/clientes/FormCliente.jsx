      ...
      {permissions.includes("Clientes") ? (
        <div className="flex items-center justify-center  lg:pt-10  max-lg:w-45 max-md:w-41 max-lg:pt-6 max-sm:text-xs">
          <div className="bg-slate-700  max-w-lg w-full p-10 shadow-lg shadow-blue-600/40 ">
            ...
            <h1 className="text-2xl flex justify-center max-sm:text-base ">
              {formTitle}
            </h1>
            <form className="mt-10" onSubmit={onSubmit}>
              ...
              {errors.nombre_cliente && (
                <p className="text-red-500">{errors.nombre_cliente.message}</p>
              )}
              ...
              {errors.email_cliente && (
                <p className="text-red-500">{errors.email_cliente.message}</p>
              )}
