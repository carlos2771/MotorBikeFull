...
export default function PageMecanicos() {
  ...
  const mostrarAlerta = (id, estado) => {
    ...
    const text = estado === "Activo" ? "¿Estás seguro de inhabilitar el mecanico?" : "¿Estás seguro de habilitar el mecanico?";
  ...
  return (
    <div className="mt-16">
      <h1 className="text-2xl text-center mx-auto">Mecanicos</h1>
