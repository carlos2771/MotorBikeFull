...
import uploadMiddleware, { addProductCart, cleartCart, createProduct, deleteProduct, getProducts, getProductsCart, putAmount, putProduct } from "../controllers/products.controller.js";
...
router.put("/products-cart/:productId", putAmount)
